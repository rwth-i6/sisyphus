...
class SisHash(unittest.TestCase):
    def test_f(self):
        ...
        for obj, ref, hash_ref in [
            ...
            ({"foo": 1, "bar": -1}, b"(dict, (tuple, (str, 'bar'), (int, -1)), (tuple, (str, 'foo'), (int, 1)))", None),
            (
                MockClass(1, 2),
                b"(MockClass, (dict, (tuple, (str, 'a'), (int, 1)), (tuple, (str, 'b'), (int, 2))))",
                None,
            ),
            (Point(3, 5), b"(Point, (tuple, (tuple, (int, 3), (int, 5)), (dict)))", None),
